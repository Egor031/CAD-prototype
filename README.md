# CADEV: Учебный CAD-редактор на базе OpenCASCADE

## Описание проекта

**CADEV** — это дипломный проект, представляющий собой учебный прототип системы автоматизированного проектирования (CAD), разработанный с использованием современных технологий 3D-моделирования. Проект создан как демонстрационная реализация базовых функций CAD-системы в рамках выпускной квалификационной работы.
